...
Namespace WindowsFormsApplication1
    ...
    Partial Public Class NorthwindDataSet
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As NorthwindDataSet = (DirectCast(MyBase.Clone(), NorthwindDataSet))
            cln.InitVars()
        ...
        Partial Public Class ProductsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddProductsRow(ByVal ProductName As String, ByVal parentCategoriesRowByFK_Products_Categories As CategoriesRow, ByVal UnitPrice As Decimal) As ProductsRow
                Dim rowProductsRow As ProductsRow = (DirectCast(Me.NewRow(), ProductsRow))
                Dim columnValuesArray() As Object = { Nothing, ProductName, Nothing, UnitPrice}
                If (parentCategoriesRowByFK_Products_Categories IsNot Nothing) Then
        ...
        Partial Public Class ProductsRow
            ...
            Public Property CategoriesRow() As CategoriesRow
                Get
                    Return (DirectCast(Me.GetParentRow(Me.Table.ParentRelations("FK_Products_Categories")), CategoriesRow))
                End Get
...
Namespace WindowsFormsApplication1.NorthwindDataSetTableAdapters
    ...
    Partial Public Class CategoriesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([CategoryName], [Description]) VALUES (@CategoryN" & "ame, @Description);" & ControlChars.CrLf & "SELECT CategoryID, CategoryName, Description FROM Categorie" & "s WHERE (CategoryID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [CategoryName] = @CategoryName, [Description] = @Description WHERE (([CategoryID] = @Original_CategoryID) AND ([CategoryName] = @Original_CategoryName));" & ControlChars.CrLf & _
"SELECT CategoryID, CategoryName, Description FROM Categories WHERE (CategoryID = @CategoryID)"
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_CategoryID = 1 AND [CategoryID] IS NULL) OR ([CategoryID] = @Original_CategoryID)) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [CategoryID], [UnitPrice]) VALUES (@" & "ProductName, @CategoryID, @UnitPrice);" & ControlChars.CrLf & "SELECT ProductID, ProductName, CategoryI" & "D, UnitPrice FROM Products WHERE (ProductID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [CategoryID] = @CategoryID, [UnitPrice] = @UnitPrice WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_CategoryID = 1 AND [CategoryID] IS NULL) OR ([CategoryID] = @Original_CategoryID)) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)));" & ControlChars.CrLf & _
"SELECT ProductID, ProductName, CategoryID, UnitPrice FROM Products WHERE (ProductID = @ProductID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, CategoryID, UnitPrice FROM dbo.Products"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
        Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID? As Integer, ByVal Original_UnitPrice? As Decimal) As Integer
            ...
            If (Original_CategoryID.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(3).Value = (CInt(Original_CategoryID.Value))
            Else
            ...
            If (Original_UnitPrice.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(5).Value = (CDec(Original_UnitPrice.Value))
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
        Public Overridable Function Insert(ByVal ProductName As String, ByVal CategoryID? As Integer, ByVal UnitPrice? As Decimal) As Integer
            ...
            If (CategoryID.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = (CInt(CategoryID.Value))
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = Global.System.DBNull.Value
            End If
            If (UnitPrice.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = (CDec(UnitPrice.Value))
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Function Update(ByVal ProductName As String, ByVal CategoryID? As Integer, ByVal UnitPrice? As Decimal, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID? As Integer, ByVal Original_UnitPrice? As Decimal, ByVal ProductID As Integer) As Integer
            If (ProductName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ProductName")
            Else
            ...
            End If
            If (UnitPrice.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = (CDec(UnitPrice.Value))
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(3).Value = (CInt(Original_ProductID))
            If (Original_ProductName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ProductName")
            Else
            ...
            If (Original_CategoryID.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = (CInt(Original_CategoryID.Value))
            Else
            ...
            If (Original_UnitPrice.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = (CDec(Original_UnitPrice.Value))
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = (DirectCast(1, Object))
                Me.Adapter.UpdateCommand.Parameters(8).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(ProductID))
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open) <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open()
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Function Update(ByVal ProductName As String, ByVal CategoryID? As Integer, ByVal UnitPrice? As Decimal, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_CategoryID? As Integer, ByVal Original_UnitPrice? As Decimal) As Integer
            Return Me.Update(ProductName, CategoryID, UnitPrice, Original_ProductID, Original_ProductName, Original_CategoryID, Original_UnitPrice, Original_ProductID)
        End Function
    End Class
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As NorthwindDataSet) As Integer
            ...
            Try
                ...
                If (Me._categoriesTableAdapter IsNot Nothing) Then
                    ...
                    Me._categoriesTableAdapter.Connection = (DirectCast(workConnection, Global.System.Data.SqlClient.SqlConnection))
                    Me._categoriesTableAdapter.Transaction = (DirectCast(workTransaction, Global.System.Data.SqlClient.SqlTransaction))
            ...
            Finally
                ...
                End If
                If (Me._categoriesTableAdapter IsNot Nothing) Then
                    Me._categoriesTableAdapter.Connection = (DirectCast(revertConnections(Me._categoriesTableAdapter), Global.System.Data.SqlClient.SqlConnection))
